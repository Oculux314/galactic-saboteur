...
/**
 * The StateButton class represents an AnimatedButton that has multiple states. 
 * Each state has its own name, image (and optional hover image), and onArrive and onLeave actions. 
 * The button cycles through states on click.
 */
public class StateButton extends AnimatedButton {

    /**
     * The State class represents a single state of the StateButton.
     * It holds the state's name, normal image, hover image, onArrive action, and onLeave action.
     */
    ...
    /**
     * Adds a new state to the StateButton with the provided name, image, onArrive, and onLeave actions.
     *
     * @param name     The name of the state.
     * @param image    The image associated with the state.
